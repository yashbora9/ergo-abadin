...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function cu(){return new pi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Jl(),fragmentShader:`
		...
		`,blending:li,depthTest:!1,depthWrite:!1})}function uu(){return new pi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Jl(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Vv(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Zh?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===dp?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Nn&&(t="SHADOWMAP_TYPE_VSM"),t}function Hv(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case yr:case Sr:t="ENVMAP_TYPE_CUBE";break;case Ta:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Gv(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Sr:t="ENVMAP_MODE_REFRACTION";break}return t}function Wv(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case $h:t="ENVMAP_BLENDING_MULTIPLY";break;case Dp:t="ENVMAP_BLENDING_MIX";break;case Up:t="ENVMAP_BLENDING_ADD";break}return t}function Xv(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function qv(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Vv(e),c=Hv(e),u=Gv(e),h=Wv(e),f=Xv(e),d=Uv(e),g=Iv(s),_=i.createProgram();let m,p,E=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Vr).join(`
`)),a=vl(a),a=yu(a,e),a=Su(a,e),o=vl(o),o=yu(o,e),o=Su(o,e),a=Eu(a),o=Eu(o),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const x=E+m+a,v=E+p+o,R=vu(i,i.VERTEX_SHADER,x),w=vu(i,i.FRAGMENT_SHADER,v);i.attachShader(_,R),i.attachShader(_,w),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(P){if(r.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(R).trim(),X=i.getShaderInfoLog(w).trim();let Y=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,R,w);else{const Z=Mu(i,R,"vertex"),G=Mu(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
